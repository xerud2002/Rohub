    ...
    <section className="py-12 bg-gray-50">
      <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-2 gap-8 items-center">
        <div>
          ...
          <p className="mt-3 text-gray-700">{t('about.description')}</p>
        ...
        <div className="rounded-lg overflow-hidden bg-gradient-to-br from-primary/10 to-primary/5 flex items-center justify-center" style={{minHeight: '320px'}}>
